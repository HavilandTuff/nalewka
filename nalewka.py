...
def create_sample_data():
    ...
    formulas = [
        ...
        BatchFormula(batch_id=batches[0].id, ingredient_id=ingredients[3].id, quantity=300, unit='grams'),
        BatchFormula(batch_id=batches[0].id, ingredient_id=ingredients[5].id, quantity=1500, unit='milliliters'),
        BatchFormula(batch_id=batches[1].id, ingredient_id=ingredients[1].id, quantity=500, unit='grams'),
        BatchFormula(batch_id=batches[1].id, ingredient_id=ingredients[4].id, quantity=200, unit='grams'),
        BatchFormula(batch_id=batches[1].id, ingredient_id=ingredients[5].id, quantity=1000, unit='milliliters')
    ]
